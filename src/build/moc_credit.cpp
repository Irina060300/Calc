...
QT_MOC_LITERAL(1, 7, 10), // "set_values"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 3), // "sum"
QT_MOC_LITERAL(4, 23, 7), // "overpay"
QT_MOC_LITERAL(5, 31, 8) // "monthpay"

    },
    "Credit\0set_values\0\0sum\0overpay\0monthpay"
};
...
void Credit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->set_values((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3]))); break;
        default: ;
        }
    }
}
